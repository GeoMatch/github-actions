        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "InvalidTag": return [3, 20];
                    case "com.amazonaws.ssm#InvalidTag": return [3, 20];
                    case "InvalidTarget": return [3, 22];
                    case "com.amazonaws.ssm#InvalidTarget": return [3, 22];
                    case "InvalidTargetMaps": return [3, 24];
                    case "com.amazonaws.ssm#InvalidTargetMaps": return [3, 24];
                    case "UnsupportedPlatformType": return [3, 26];
                    case "com.amazonaws.ssm#UnsupportedPlatformType": return [3, 26];
                }
                return [3, 28];
            ...
            case 20: return [4, deserializeAws_json1_1InvalidTagResponse(parsedOutput, context)];
            case 21: throw _d.sent();
            case 22: return [4, deserializeAws_json1_1InvalidTargetResponse(parsedOutput, context)];
            case 23: throw _d.sent();
            case 24: return [4, deserializeAws_json1_1InvalidTargetMapsResponse(parsedOutput, context)];
            case 25: throw _d.sent();
            case 26: return [4, deserializeAws_json1_1UnsupportedPlatformTypeResponse(parsedOutput, context)];
...
var deserializeAws_json1_1InvalidTagResponse = function (parsedOutput, context) { return __awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, exception;
    return __generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_json1_1InvalidTag(body, context);
        exception = new InvalidTag(__assign({ $metadata: deserializeMetadata(parsedOutput) }, deserialized));
        return [2, __decorateServiceException(exception, body)];
    });
}); };
...
var serializeAws_json1_1AlarmConfiguration = function (input, context) {
    return __assign(__assign({}, (input.Alarms != null && { Alarms: serializeAws_json1_1AlarmList(input.Alarms, context) })), (input.IgnorePollAlarmFailure != null && { IgnorePollAlarmFailure: input.IgnorePollAlarmFailure }));
};
...
var serializeAws_json1_1CreateAssociationBatchRequestEntry = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.AlarmConfiguration != null && {
        AlarmConfiguration: serializeAws_json1_1AlarmConfiguration(input.AlarmConfiguration, context),
    })), (input.ApplyOnlyAtCronInterval != null && { ApplyOnlyAtCronInterval: input.ApplyOnlyAtCronInterval })), (input.AssociationName != null && { AssociationName: input.AssociationName })), (input.AutomationTargetParameterName != null && {
...
var serializeAws_json1_1CreateAssociationRequest = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.AlarmConfiguration != null && {
        AlarmConfiguration: serializeAws_json1_1AlarmConfiguration(input.AlarmConfiguration, context),
    })), (input.ApplyOnlyAtCronInterval != null && { ApplyOnlyAtCronInterval: input.ApplyOnlyAtCronInterval })), (input.AssociationName != null && { AssociationName: input.AssociationName })), (input.AutomationTargetParameterName != null && {
        AutomationTargetParameterName: input.AutomationTargetParameterName,
    })), (input.CalendarNames != null && {
...
var serializeAws_json1_1RegisterTaskWithMaintenanceWindowRequest = function (input, context) {
    var _a;
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.AlarmConfiguration != null && {
        AlarmConfiguration: serializeAws_json1_1AlarmConfiguration(input.AlarmConfiguration, context),
...
var serializeAws_json1_1StartAutomationExecutionRequest = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.AlarmConfiguration != null && {
        AlarmConfiguration: serializeAws_json1_1AlarmConfiguration(input.AlarmConfiguration, context),
...
var deserializeAws_json1_1AlarmStateInformation = function (output, context) {
    return {
        Name: __expectString(output.Name),
        State: __expectString(output.State),
    };
};
var deserializeAws_json1_1AlarmStateInformationList = function (output, context) {
    var retVal = (output || [])
        .filter(function (e) { return e != null; })
        .map(function (entry) {
        if (entry === null) {
...
var deserializeAws_json1_1InvalidTag = function (output, context) {
    return {
        Message: __expectString(output.Message),
    };
};
